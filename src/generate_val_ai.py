...
from google.genai import types  # Gemini temperature ayarı için gerekli
...
# API Key Kontrolleri ve İstemci Başlatma
try:
    gemini_client = genai.Client(api_key=os.getenv("GOOGLE_API_KEY"))
    openai_client = OpenAI(api_key=os.getenv("OPENAI_API_KEY"))
    claude_client = Anthropic(api_key=os.getenv("ANTHROPIC_API_KEY"))
    
    # DeepSeek, OpenAI SDK'sını base_url ile destekler
...
# ===========================================================================
# 4. ORTAK API SÜRÜCÜSÜ (Resmi Claude 4.5 Jenerasyonu Güncellendi)
# ===========================================================================
def call_specific_llm(model_name, prompt):
    ...
    if model_name == "gemini":
        ...
        # Resmi dökümantasyondaki en güncel model alias ismi tanımlandı
...
# ===========================================================================
# 5. MATEMATİKSEL BÖLÜNTÜLÜ ANA DÖNGÜ (Main)
# ===========================================================================
def main():
    input_path = "data/interim/human_val.csv"
    output_path = "data/interim/ai_val.csv"
    ...
    print(f"🚀 Validation Seti Üretim Sistemi Başlatıldı. Model Başına Yük: {chunk_size} Satır.")

    for index, row in tqdm(df_human.iterrows(), total=total_rows, desc="Validation"):
        o_tez_no = row['tez_no']
        baslik = row['baslik']
